...
happy_text_corpus <- tm_map(happy_text_corpus, removeWords, c("happy","btc"))
...
plot(dendograma, hang=-1,main = "Dendograma Tweets happy - Outspoken Market",
     xlab = "Distancia",
     ylab = "Altura")  
...
clusplot(as.matrix(distancia), kmeans_btc$cluster, color=T, shade=T, labels=3, lines=0,
         main = "K-Means Tweets happy - Outspoken Market",
         xlab = "PC1",
         ylab = "PC2") 
